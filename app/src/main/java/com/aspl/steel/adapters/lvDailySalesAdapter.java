 ...
 */
public class lvDailySalesAdapter extends BaseAdapter{
    String LOG_DBG=this.getClass().getSimpleName();
    public JSONArray myList ;
    LayoutInflater inflater;
    AppCompatActivity context;

    public lvDailySalesAdapter(AppCompatActivity context, JSONArray myList) {
        super();
        this.myList = myList;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        String dealerName,itemName,unit;
        BigDecimal quantity;
        int decimalPlaces;
        try{
            ...
            dealerName=data.getString("dealerName");
    ...
    private class MyViewHolder {
        TextView dealerName,itemName,unit,quantity;
