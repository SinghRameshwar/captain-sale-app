...
public class DisticSpinerAdapter extends BaseAdapter {

    JSONArray jsonArray;
    Context context;
    LayoutInflater inflater;

    public DisticSpinerAdapter(Context context, JSONArray jsonArray) {
        super();
    ...
    public View getView(int i, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            mainTitle.setText(object.getString("name"));
