 ...
 */
public class RequisitionDealerNameAutocompleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String dealerId=getIntent().getExtras().getString("dealerId", "");
        ...
        lvDealerName.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("contact",hashMap.get("contact").toString());
        ...
        searchName.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(final Editable s) {
                ...
                if(s.length()>=1){
                    ...
                    mFetchTask = new FetchDealerName(RequisitionDealerNameAutocompleteActivity.this, 1);
                    mFetchTask.execute(cid, segid, sLid, type, s.toString(), tempKeyCode,dealerId);
                }else {
        ...
        protected String doInBackground(String... arg0 ) {
            if(byGetOrPost == 0){ //means by Get Method
                ...
                try{
                    ...
                    String dealerId=arg0[6];
                    String dnsport= GlobalConfiguration.getDomainport();
                    String link="http://"+dnsport+"/SteelSales-war/Stl_Party_SearchBySlidDealerId_C_Api";
                    HashMap<String,String> hm=new HashMap<>();
                    hm.put("cid",cid);
                    hm.put("segid", segid);
                    hm.put("sLid", sLid);
                    hm.put("type", type);           //type is dealer or subdealer
                    hm.put("dealerId", dealerId);   //0 for dealer else Id for subdealer
                    hm.put("q", query);
           ...
           // Log.e(LOG_DBG,".........   "+result);
            try{
                ...
                if(mainObj.getString("msg").contains("Authorization Failure")){
                    ...
                    Toast.makeText(RequisitionDealerNameAutocompleteActivity.this,"Session expired.",Toast.LENGTH_SHORT).show();
