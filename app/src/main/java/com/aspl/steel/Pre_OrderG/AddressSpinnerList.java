...
public class AddressSpinnerList extends BaseAdapter {

    JSONArray jsonArray;
    Context context;
    LayoutInflater inflater;

    public AddressSpinnerList(Context context, JSONArray jsonArray) {
        super();
    ...
    public View getView(int i, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            mainTitle.setText(object.getString("address")+":: "+object.getString("addressDtls"));
