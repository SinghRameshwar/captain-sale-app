...
public class MasonCompSpnAdapter extends BaseAdapter {

    JSONArray jsonArray;
    Context context;
    LayoutInflater inflater;

    public MasonCompSpnAdapter(Context context, JSONArray jsonArray) {
        super();
    ...
    public View getView(int i, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            mainTitle.setText(object.getString("vnum")+","+object.getString("meet_date")+","+object.getString("dealer_name"));
